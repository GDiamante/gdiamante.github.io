                    ...
                    <div className="flex min-w-max gap-4 sm:gap-5">
                        {recentPosts.map((post) => (
                            <Link
                                ...
                                className="group"
                            >
                                <article className="relative flex h-56 min-w-[13rem] max-w-[13rem] flex-col justify-between rounded-2xl border border-slate-600/30 bg-slate-800/40 p-4 shadow-sm transition hover:border-slate-500/40 hover:bg-slate-700/30 hover:shadow-md sm:h-64 sm:min-w-[15rem] sm:max-w-[15rem]">
